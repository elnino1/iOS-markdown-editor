...
- [x] **PREV-01**: User can toggle between edit mode and preview mode via a button in the editor navigation bar
...
- [x] **PREV-08**: User can tap a link in preview to open it in an in-app browser (SFSafariViewController)
